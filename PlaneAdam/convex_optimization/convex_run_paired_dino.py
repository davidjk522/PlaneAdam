# the main code for running the paired DINO features to optimize using ConvexAdam
import argparse
import sys
import time
import warnings
...
def main(gpunum, configfile, pca_dim=None, adam_niter=None):
    ...
    run_name = f'dice{best_dice:.3f}{param_suffix}{pca_suffix}{adam_suffix}_{time.strftime("%Y%m%d_%H%M%S")}'
