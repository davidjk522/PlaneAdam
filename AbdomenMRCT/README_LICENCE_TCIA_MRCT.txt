...
Learn2Reg MR/CT registration dataset modified from The Cancer Imaging Archive (TCIA) project:
...
Learn2Reg organisers have provided manual segmentations for 16 MRIs and 16 CTs for four anatomies (if present):
liver, spleen, rkidney, lkidney
https://learn2reg.grand-challenge.org

Released using affine pre-registration based on the deeds-linear algorithm as part of Learn2R$
...
Material is available under TCIA Data Usage Policy and Creative Commons Attribution 3.0 Unported License.
